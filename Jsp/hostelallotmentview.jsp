...
<html>
  <head>
    <title>HOSTEL ALLOTMENT VIEW</title><link rel="stylesheet" href="../../sheet1.css">
  						...
  						<fieldset>
    						...
    						<table cellpadding="5">
    							<tr>
    								...
    								<td>
    									<input type="text" name="rollno" id="rollno" onblur="fun(this.value)" title="enter student details"/>
    								</td>
    								<th align="left">
    									Branch: 
    								</th>
